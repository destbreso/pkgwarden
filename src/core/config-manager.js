...
const DEFAULT_CONFIG = {
  ...
  rules: {
    ...
    typosquatting: true, // Check for typosquat name confusion
    hiddenChars: true, // Detect hidden Unicode/bidi/homoglyph chars
...
# Centralized policy layer for package security across any package manager
...
# Source code scanning rules (pre-install analysis)
rules:
  ...
  typosquatting: ${config.rules.typosquatting}           # Check for typosquat name confusion
  hiddenChars: ${config.rules.hiddenChars}               # Detect hidden Unicode, bidi overrides, homoglyphs
...
policies:
  ...
  registryUrl: ${config.policies.registryUrl}
